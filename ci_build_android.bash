...
wget -nc $POJAV_NATIVES/libopenal.so -P $LWJGL_NATIVE/openal || true
...
# Download VMA library (添加 VMA 支持)
wget -nc "https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator/releases/latest/download/VulkanMemoryAllocator.zip" || true
if [ -f VulkanMemoryAllocator.zip ]; then
    unzip -o VulkanMemoryAllocator.zip -d $LWJGL_NATIVE/vma || true
fi
...
# Build LWJGL 3 (启用 shaderc vma vulkan)
ant -version
